from sqlalchemy import Boolean, Column, Integer, String, ForeignKey, DateTime, func, null
...
class BookingEntry(Base):
    ...
    first_spacial_name = Column(String(100), nullable=True, default=None)
    second_spacial_name = Column(String(100), nullable=True, default=None)
    addons_selected = Column(String(50))
    booking_name = Column(String(100))
    booking_mobile = Column(String(15))
    booking_email = Column(String(100), nullable=True, default=None)
    advance_amount = Column(Integer, nullable=True, default=0)
    is_active = Column(Boolean, default=True, nullable=True)
    discount_coupon = Column(String(50), nullable=True, default=None)
    referral_code = Column(String(50), nullable=True, default=None)
    created_date = Column(DateTime(timezone=True), server_default=func.now(), nullable=True)
